...
import com.fangbinbin.appframework.management.BitmapManagement;
...
public class ConnectionHandler {
    ...
    public static JSONObject getJsonObject(String url, String userId) throws ClientProtocolException, IOException, JSONException, FrameworkException, IllegalStateException, FrameworkForbiddenException {
     ...
     */
    public static String getString(String url, String userId) throws ClientProtocolException, IllegalStateException, IOException, FrameworkException, JSONException, FrameworkForbiddenException {
    ...
    public static JSONArray getJsonArray(String url, String userId,
                                         String token) throws ClientProtocolException, IOException, JSONException, FrameworkException, IllegalStateException, FrameworkForbiddenException {
    ...
    public static JSONObject postJsonObject(String apiName,JSONObject create, String userId,
                                            String token) throws ClientProtocolException, IOException, JSONException, IllegalStateException, FrameworkException, FrameworkForbiddenException {

        JSONObject retVal = null;

        InputStream is = httpPostRequest(ServerRequestHandler.getUrl() + apiName, create, userId);
        String result = getString(is);
    ...
    public static JSONObject postJsonObject(JSONObject create, String userId,
                                            String token) throws IOException, JSONException, IllegalStateException, FrameworkException, FrameworkForbiddenException {

        JSONObject retVal = null;

        InputStream is = httpPostRequest(ServerRequestHandler.getUrl(), create, userId);
        String result = getString(is);
    ...
    public static JSONObject postAuth(JSONObject jPost) throws IOException,
            JSONException, IllegalStateException, FrameworkException, FrameworkForbiddenException {

        JSONObject retVal = null;

        InputStream is = httpPostRequest(ServerRequestHandler.getAuthUrl(), jPost, "");
        String result = getString(is);
...
//		try {
//
//			InputStream is = httpDeleteRequest(ServerRequestHandler.getUrl() + documentId
...
//		try {
//
//			InputStream is = httpPutRequest(ServerRequestHandler.getUrl() + id, create,
//					userId);
//			String result = getString(is);
//
//			is.close();
...
//	}
    ...
    public static void getFile(String url, File file, String userId,
                               String token) throws ClientProtocolException, IOException, FrameworkException, IllegalStateException, JSONException, FrameworkForbiddenException {
     ...
     * @throws FrameworkForbiddenException
     */
    public static InputStream httpGetRequest(String url, String userId) throws ClientProtocolException, IOException, FrameworkException, IllegalStateException, JSONException, FrameworkForbiddenException {
        ...
        if(userId != null && userId.length() > 0)
            ...
            String userIdSaved = FrameworkApp.getPreferences().getUserId();
            if(userIdSaved != null)
                httpget.setHeader("user_id", userIdSaved);
        }

        String token = FrameworkApp.getPreferences().getUserToken();

        if(token != null && token.length() > 0)
            httpget.setHeader("token", token);

        Logger.error("httpGetRequest", FrameworkApp.getPreferences().getUserToken());
        ...
        if (response.getStatusLine().getStatusCode() > 400)
        {
            ...
            if (response.getStatusLine().getStatusCode() == 500) throw new FrameworkException(getError(entity.getContent()));
            if (response.getStatusLine().getStatusCode() == 403) throw new FrameworkForbiddenException();
    ...
    private static InputStream httpPostRequest(String url, Object create,
            ...
            IOException, IllegalStateException, FrameworkException, JSONException, FrameworkForbiddenException {
    ...
    public static String getIdFromFileUploader(String url,
                                               List<NameValuePair> params) throws ClientProtocolException, IOException, UnsupportedOperationException, FrameworkException, JSONException {
        // Making HTTP request
